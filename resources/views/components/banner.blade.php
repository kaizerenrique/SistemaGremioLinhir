...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 
        ...
        'bg-neutro': style != 'success' && style != 'danger' && style != 'warning'
    }"
    style="display: none;"
    x-show="show && message"
        ...
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 
                    'bg-success/90': style == 'success', 
                    'bg-error/90': style == 'danger', 
                    'bg-warning/90': style == 'warning',
                    'bg-neutro/90': style != 'success' && style != 'danger' && style != 'warning'
                }">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 
                        'hover:bg-success/80 focus:bg-success/80': style == 'success', 
                        'hover:bg-error/80 focus:bg-error/80': style == 'danger', 
                        'hover:bg-warning/80 focus:bg-warning/80': style == 'warning',
                        'hover:bg-neutro/80 focus:bg-neutro/80': style != 'success' && style != 'danger' && style != 'warning'
                    }"
                    aria-label="Dismiss"
