        ...
        <div class="flex flex-wrap -m-4 text-center">
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div class="border-2 border-primary px-4 py-6 rounded-lg">
                    ...
                    @if ($oro['precio_actual'])
                        <h2 class="title-font font-medium text-3xl text-content-light">{{ number_format($oro['precio_actual'], 0, '', '.') }} Plata</h2>
                ...
                <div class="flex flex-wrap w-full md:pr-10 md:py-6 ">
                    <div class="flex relative pb-12">
                        ...
                        <div class="flex-grow pl-4">
                            <h2 class="font-medium title-font text-sm text-white mb-1 tracking-wider">STEP 1
                            </h2>
                    ...
                    <div class="flex relative pb-12">
                        ...
                        <div class="flex-grow pl-4">
                            <h2 class="font-medium title-font text-sm text-white mb-1 tracking-wider">STEP 2
                            </h2>
                    ...
                    <div class="flex relative pb-12">
                        ...
                        <div class="flex-grow pl-4">
                            <h2 class="font-medium title-font text-sm text-white mb-1 tracking-wider">STEP
                                3</h2>
                            <p class="leading-relaxed">Coloring book nar whal glossier master cleanse
                                umami. Salvia +1
