<footer class="bg-dark border-t border-accent/20">
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex flex-col items-center md:items-start space-y-4">
                <div class="flex items-center gap-3 hover:scale-110 transition-transform">
                    ...
                    <span class="text-2xl font-bold text-accent">LINHIR</span>
                </div>
                <p class="text-light text-sm text-center md:text-left">
            ...
            <div class="flex space-x-6">
                <a href="https://discord.gg/tu-enlace" target="_blank" rel="noopener"
                    class="text-light hover:text-[#5865F2] transition-colors">
                    <i class="fab fa-discord text-3xl"></i>
                </a>
                <a href="https://youtube.com/tu-canal" target="_blank" rel="noopener"
                    class="text-light hover:text-[#FF0000] transition-colors">
        ...
        <div class="mt-8 pt-6 border-t border-accent/10">
            <p class="text-center text-light text-sm">
