    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('blog.index') }}" class="text-content-light hover:text-content-accent transition-colors">Blog</a>
        ...
        <div class="md:hidden" 
            ...
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="{{ route('blog.index') }}" class="text-content-light hover:text-content-accent px-3 py-2">Blog</a>
