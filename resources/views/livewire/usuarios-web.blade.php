<div class="bg-base-300 sm:rounded-lg">
                ...
                <tbody class="text-content-light bg-base-300 divide-y divide-primary/30">
                    @foreach ($usuarios as $usuario)
                        <tr class="text-content-light">
                            ...
                            <th
                                class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left" >
                                <div class="" wire:click="editarrol({{ $usuario->id }})">
    ...
    <!-- Seccion que contiene el modal  -->
        <x-confirmation-modal wire:model="modaleditar">
            ...
            <x-slot name="footer">
                <x-danger-button class="ml-2" wire:click="$toggle('modaleditar')" wire:loading.attr="disabled">
                    Cerrar
                </x-danger-button>
            </x-slot>
